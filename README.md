...
> **Ryuto Kawazu** (自称偽名)  
> 別名「曇りに曇ったクラウドサービスlocaler」

本屋さんで見たHTMLとCSSのデザインの本に惹かれ、中1のときにプログラミングを始めた  

思いつきでコーディングするのが好き  
遊び心あるニックネームが思いついては、すぐプロフィールに採用する  

AIを使って開発しようとしたが、コードを破壊したりハルシネーションばかりなので諦めた  
(多分、僕の使い方が下手)

---

中2~3にかけて、**「BlogBooks Library」** という技術サイトの所有者となり、フィルタリングの脆弱性をもとに **Google Chrome** の拡張機能でのフィルタリングを解除するための [**exploit.js**](https://github.com/reactor-coding/silver/tree/main/exploit.js) などを作成  

高1に **「Next.js」** に触れ、高2に **脱「React」** として **「SvelteKit」** に浮気  

高3となった現在も、主に **「SvelteKit」** を使ったWeb開発を続けている
...
- **好きな名言**: 「点Pは右方向に、点Qは左方向へ移動します。二度と会うことはないでしょう by No4h」
